...
def filter_tlog(readers, output_filename, msg_types, sysid, compid, max_msgs, verbose):
    """
    ...
    with open(output_filename, 'wb') as outfile:
        ...
        for reader in readers:
            for msg in reader:
                ...
                if max_msgs > 0 and kept_count >= max_msgs:
...
def main():
    ...
    parser.add_argument('--output', default='filtered.tlog',
    ...
    filter_tlog(readers, args.output, msg_types, args.sysid, args.compid, args.max_msgs, args.verbose)
