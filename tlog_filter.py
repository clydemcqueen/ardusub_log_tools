...
def main():
    ...
    parser.add_argument(
        "--types", default=None, help='comma separated list of message types, e.g., "ATTITUDE,RC_CHANNELS"'
    )
    parser.add_argument("--sysid", type=int, default=None, help="select source system id, default is all systems")
    parser.add_argument(
        "--compid", type=int, default=None, help="select source component id, default is all components"
    )
    parser.add_argument(
        "--max-msgs", type=int, default=500000, help="stop after keeping this number of messages, default is 500K"
    )
