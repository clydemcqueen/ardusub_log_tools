...
"""
Read MAVLink messages and BlueOS extension logs from an MCAP file and write CSV files.
...
Supports segments and optional merged CSV output.
"""
...
def main():
    ...
    parser.add_argument("--merge", action="store_true", help="write a merged csv file across all selected types")
    parser.add_argument("--no-explode", action="store_true", help="do not write per-message-type csv files")
